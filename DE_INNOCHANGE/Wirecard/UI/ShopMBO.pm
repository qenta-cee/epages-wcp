#========================================================================================
# §package      DE_INNOCHANGE::Wirecard::UI::ShopMBO
# §base         DE_EPAGES::Order::UI::Shop
# §state        public
#----------------------------------------------------------------------------------------
# §description  this package is used for searching and sorting transactions in MBO
#
...
#========================================================================================
package DE_INNOCHANGE::Wirecard::UI::ShopMBO;
use base DE_EPAGES::Order::UI::Shop;

use strict;

#========================================================================================
# §function     TransactionPaymentName
# §state        public
#----------------------------------------------------------------------------------------
# §syntax       my $TransactionPaymentName = TransactionPaymentName();
#----------------------------------------------------------------------------------------
# §description  with the name returned the transaction search can be executed automatically
#----------------------------------------------------------------------------------------
# §return       $TransactionPaymentName | string which is part of the names of both line item class and search | string
#========================================================================================
sub TransactionPaymentName { 'ICWirecard' }
